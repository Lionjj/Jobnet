            ...
            <div x-data="{ open: false }" x-init="open = new URLSearchParams(window.location.search).has('open_filters')" class="max-w-4xl mx-auto mb-6">
                ...
                >
                    ...
                    <button
                        ...
                        onclick="window.location.href='{{ route('jobs.publicIndex', array_merge(request()->except(['open_filters', 'skill', 'benefit', 'job_type', 'contract_type', 'experience_level', 'keyword', 'location']), ['open_filters' => 1])) }}'"
                    >
                        Reset
                    </button>
